...
## RTK外部话题输出的问题
问：是不是外部随便一个模组有nmea就可以输出带坐标的定位?

是的，只要rtk模组支持输出10hz NMEA的GGA消息以及1hz以上的RMC消息理就能实现从外部发布/rtk_nmea消息，让viobot2里的ros程序订阅到，viobot2会发布/baton/rtk的话题，上位机上再设置好RTK的模式，就可输出融合了rtk的位姿，按需求订阅需要的位姿即可。具体的使用可到[融合位姿](https://baton-doc.readthedocs.io/en/viobot2/%E8%9E%8D%E5%90%88%E4%BD%8D%E5%A7%BF/index.html#)章节去查看。
