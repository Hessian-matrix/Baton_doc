...
建议采用无linux桌面图形化的开放和使用方式，用户可以使用Mobaxterm、xshell等终端工具用ssh登录Viobot2,登录使用可以参考本文档的[开机指南章节](https://baton-doc.readthedocs.io/en/viobot2/%E5%BC%80%E6%9C%BA%E6%8C%87%E5%8D%97.html#)
