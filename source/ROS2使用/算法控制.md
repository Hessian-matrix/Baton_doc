...
算法的控制我们整合成了一个ROS msg，具体的msg信息可以查看[ros2\_interface](https://github.com/Hessian-matrix/ROS2_interfaces "ros2_interface")里面的system\_ctrl包的AlgoCtrl.msg，需要先下载包的源码在自己电脑上面编译一下后才能使用。
...
#### 使用命令行发送话题：
以stereo3为例，stereo4将下面命令的`stereo3`改为`stereo4`即可
...
算法的状态也是一个ROS2 msg，具体的msg信息可以查看[ros2\_interface](https://github.com/Hessian-matrix/ROS2_interfaces "ros2_interface")里面的systtem\_ctrl包的AlgoStatus.msg，需要先下载包的源码在自己电脑上面编译一下后才能使用。
